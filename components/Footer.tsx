...
export function Footer() {
  return (
    <footer className="border-t bg-gray-50">
      <div className="container mx-auto max-w-7xl flex flex-col gap-4 py-10 md:flex-row md:gap-8 md:py-12">
        <div className="flex flex-col gap-2 md:gap-4 lg:flex-1">
          ...
          <p className="text-sm text-gray-500 md:text-base">
            Profesjonelle løsninger for utleie av IT-utstyr for alle bedrifter
            størrelser.
          </p>
        </div>
        <div className="grid flex-1 grid-cols-2 gap-8 sm:grid-cols-3">
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-medium">Utstyr</h3>
            <ul className="space-y-2">
              <li>
                <Link
      ...
      <div className="border-t py-6">
        <div className="container mx-auto max-w-7xl flex flex-col items-center justify-between gap-4 md:flex-row">
          <p className="text-center text-sm text-gray-500 md:text-left">
            © {new Date().getFullYear()} ImpactIT. All rights reserved.
          </p>
